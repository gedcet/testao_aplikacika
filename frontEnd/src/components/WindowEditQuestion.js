        ...
        try
        {
            const axios1 = await axios({
                ...
                "data": {
                    ...
                    "answers": [
                        {
                            "text": props.state.answers[0].text,
                            "correct": props.state.answers[0].correct
                        },
                        {
                            "text": props.state.answers[1].text,
                            "correct": props.state.answers[1].correct
                        },
                        {
                            "text": props.state.answers[2].text,
                            "correct": props.state.answers[2].correct
                        },
                        {
                            "text": props.state.answers[3].text,
                            "correct": props.state.answers[3].correct
                        }
                    ]
                }
            })
        ...
        <div className="window_edit_question">
            ...
            <label>1
                <input
                    type="text"
                    className="answtxt"
                    value={props.state.answers[0].text}
                    onChange={change_field_value}
                    ref={refAnswer1Text}>
                </input>
            </label>
            ...
            <label>Correct
                <input
                    type="checkbox"
                    checked={props.state.answers[0].correct}
                    onChange={change_field_value}
                    ref={refAnswer1Correct}>
                </input>
            </label>
            <br />
            ...
            <label>2
                <input
                    type="text"
                    className="answtxt"
                    value={props.state.answers[1].text}
                    onChange={change_field_value}
                    ref={refAnswer2Text}>
                </input>
            </label>
            ...
            <label>Correct
                <input
                    type="checkbox"
                    checked={props.state.answers[1].correct}
                    onChange={change_field_value}
                    ref={refAnswer2Correct}>
                </input>
            </label>
            <br />
            ...
            <label>3
                <input
                    type="text"
                    className="answtxt"
                    value={props.state.answers[2].text}
                    onChange={change_field_value}
                    ref={refAnswer3Text}>
                </input>
            </label>
            ...
            <label>Correct
                <input
                    type="checkbox"
                    checked={props.state.answers[2].correct}
                    onChange={change_field_value}
                    ref={refAnswer3Correct}>
                </input>
            </label>
            <br />
            ...
            <label>4
                <input
                    type="text"
                    className="answtxt"
                    value={props.state.answers[3].text}
                    onChange={change_field_value}
                    ref={refAnswer4Text}>
                </input>
            </label>
            ...
            <label>Correct
                <input
                    type="checkbox"
                    checked={props.state.answers[3].correct}
                    onChange={change_field_value}
                    ref={refAnswer4Correct}>
                </input>
            </label>
            <br></br><br></br>
