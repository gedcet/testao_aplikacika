...
const WindowEditQuestion = (props) =>
{
    ...
    const change_field_value = () =>
    {
        ...
        if (copy_of_state.answers.length > 2)
        {
    ...
    return (
        <div className="WindowEditQuestion">
            ...
            {props.state.answers.length > 0 ? < Answer set_nr="1. " set_value={props.state.answers[0].text} set_onChange={change_field_value} set_ref_text={refAnswer1Text} set_ref_checked={refAnswer1Correct} set_checked={props.state.answers[0].correct} /> : null}
            {props.state.answers.length > 1 ? < Answer set_nr="2. " set_value={props.state.answers[1].text} set_onChange={change_field_value} set_ref_text={refAnswer2Text} set_ref_checked={refAnswer2Correct} set_checked={props.state.answers[1].correct} /> : null}
            {props.state.answers.length > 2 ? < Answer set_nr="3. " set_value={props.state.answers[2].text} set_onChange={change_field_value} set_ref_text={refAnswer3Text} set_ref_checked={refAnswer3Correct} set_checked={props.state.answers[2].correct} /> : null}
            {props.state.answers.length > 3 ? < Answer set_nr="4. " set_value={props.state.answers[3].text} set_onChange={change_field_value} set_ref_text={refAnswer4Text} set_ref_checked={refAnswer4Correct} set_checked={props.state.answers[3].correct} /> : null}

            <button onClick={send_request_edit_question}>save</button>
            <button onClick={() => { props.setShowWindow(null) }}>Close </button>
        </div>
    )
}
